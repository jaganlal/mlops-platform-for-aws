...
const image = awsx.ecr.buildAndPushImage('simple_model_demo-image', {
  context: '../',
});
...
const deployment = new kx.Deployment('simple_model_demo-serving', {
...
new TraefikRoute('simple_model_demo', {
  prefix: '/models/simple_model_demo',
  service,
  namespace: 'default',
